    ...
    <Sidebar auth={auth1} ></Sidebar>
      ...
      <div>
        <Routes>
          ...
          <Route path="/fournisseurs/:_id/edit" element={<PrivateOutlet />} auth={auth1}>
          ...
          <Route path="/clients/:_id/edit" element={<PrivateOutlet />}auth={auth1}>
            <Route path="" element={<UpdateCustomer />} />
          </Route>
          <Route path="/stock/:_id/edit" element={<PrivateOutlet />}auth={auth1}>
          ...
          <Route path="/listCategories" element={<PrivateOutlet />}auth={auth1}>
            <Route path="" element={<CategoryHolder />} />
          </Route>
          <Route path="/categories/:_id/edit" element={<PrivateOutlet />}auth={auth1}>
            <Route path="" element={<UpdateCategory />} />
          </Route>
          <Route path="/produits/:_id/edit" element={<PrivateOutlet />}auth={auth1}>
            <Route path="" element={<UpdateProduct />} />
          </Route>
          <Route path="/directions/:_id/edit" element={<PrivateOutlet />}auth={auth1}>
          ...
          <Route path="/employes/:_id/edit" element={<PrivateOutlet />}auth={auth1}>
            <Route path="" element={<UpdateEmployee />} />
          </Route>
          <Route path="/employes/:_id/details" element={<PrivateOutlet />}auth={auth1}>
            <Route path="" element={<OneEmploye />} />
          </Route>
          <Route path="/nouveau-employe" element={<PrivateOutlet />}auth={auth1}>
          ...
          {/* //*Ordinaires**/ }
          <Route path="/historique-achat" element={<PrivateOutlet />}auth={auth1}>
            <Route path="" element={<HistoriqueAchats />} />
          </Route>
          <Route path="/ajout-facture-achat" element={<PrivateOutlet />}auth={auth1}>
            <Route path="" element={<NewAchatForm />} />
          </Route>
          <Route path="/facture-achat/panier" element={<PrivateOutlet />}auth={auth1}>
         ...
         {/*  //*Avoir**/ }
          ...
          <Route path="/ajout-avoir-achat" element={<PrivateOutlet />}auth={auth1}>
         ...
         {/*  //*Ordinaires**/ }
          <Route path="/historique-ventes" element={<PrivateOutlet />}auth={auth1}>
            <Route  path="" element={<HistoriqueVentes />} />
          </Route>
          <Route path="/ajout-facture-vente" element={<PrivateOutlet />}auth={auth1}>
          ...
          <Route path="/ajout-avoir-vente" auth={auth1} element={<PrivateOutlet />}>
            <Route path="" element={<FormAvoirVentes />} />
          </Route>
          {/* //*échéance**/ }
          <Route path="/echeances-vente" auth={auth1}element={<PrivateOutlet />}>
          ...
          <Route path="/gestion-demandes"auth={auth1} element={<PrivateOutlet />}>
