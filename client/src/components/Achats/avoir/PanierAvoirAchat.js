        ...
        <div className="container">
          ...
          <div className="row my-2 container">
            <div className="d-flex align-items-center py-3">
              <div className="col-6">
                ...
                Date :
               {moment(lastF.dateAvoir).locale("fr").format("LL")}   
              </div>
          ...
          <div className="row my-2">
            <div className="d-flex align-items-center">
              <div className="col-9">
                <h5 className="fs-4">Articles à annuler</h5>
              </div>
          ...
          <table className="table table-hover mb-5">
           ...
           <ListeAvoirSurAchat listeOfAchats={tabLignesFiltred}></ListeAvoirSurAchat>
            </tbody>
          </table>
          </div>
          <hr />
            ...
            <div className="d-flex align-items-center">
              <div className="col-6 mx-2">
                  ...
                  {tabLignesFiltred.length?(
                    <b className="fs-4">Somme à recevoir:   {lastF.somme_a_recevoir}   DT</b>
                  ):""
                  }   
              </div>
            </div>
