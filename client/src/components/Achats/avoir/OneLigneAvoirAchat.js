...
export default function OneLigneAvoirAchat(props) {
    ...
    function removeC(){
        ...
        if(result){
          ...
          ligneCtx.removeOneLigneAvoirSurAchat(props.ligne._id)
        ...
        >
          <Box sx={style}>
            ...
            <form onSubmit={event => {
               ...
               ligneCtx.updateLigneAvoirSurAchat(props.ligne._id,line);
              window.location.reload() }}>
