...
export default function NewFormVente() {
  ...
  function submitHandler(e) {
    e.preventDefault();
    const c = ListeClients.find(
      (p) => p.nomClient === refclient_id.current.value
    );
    let newInvoice = {
      ...
      <>
        <div style={{ display: "flex" }}>
          <div className="container">
            <h6 className="display-6">Nouvelle facture de vente</h6>
            <hr />
            ...
            >
              ...
              <div className="d-flex flex-row-reverse">
                ...
                <div className="p-2">
                  <Link to="/ventes" className="btn btn-danger my-2 mr-2">
