...
export default function OneLigneAvoirVente(props) {
    ...
    function removeC(){
        ...
        if(result){
          ...
          ligneCtx.removeOneLigneAvoirSurVente(props.ligne._id)
            ...
            >
              <Box sx={style}>
                ...
                <form onSubmit={event => {
                   ...
                   ligneCtx.updateLigneAvoirSurVente(props.ligne._id,line);
                  window.location.reload() }}>
