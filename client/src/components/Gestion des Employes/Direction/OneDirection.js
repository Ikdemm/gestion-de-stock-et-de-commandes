...
export default function OneDirection(props) {
  ...
  function removeC() {
    if (
      window.confirm(
        "Etes-vous sur de bien vouloir supprimer cette direction ? Sachant que tous les employés y inclus seront supprimés ainsi"
      )
    ) {
    ...
    <div>
      <div className="row mb-1 mr-0 custom-border ">
        <div className="col-md-2 custom-border-right p-1 text-center">
          <img
            src={require("../../../assets/images/direction.jpg")}
            alt="direction static"
            width="100px"
            height="100px"
          />
        </div>
        ...
        <Box sx={style}>
          ...
          <form onSubmit={submitHandler}>
            ...
            <input
              ...
              type="text"
              name="name"
              defaultValue={props.direction.name}
              ref={refName}
            ></input>
