        ...
        <div style={{ display: "flex" }}>
          <div className="container-fluid">
            ...
            >
              <div className="row mb-2">
                <div className="col-md-6">
                  ...
                  <input
                    ...
                    name="numCIN"
                    ref={refCIN}
                    defaultValue={selectedEmployee.numCIN}
                  ></input>
                </div>
                <div className="col-md-6">
              ...
              <div className="row mb-2">
                <div className="col-md-6">
                  ...
                  <input
                    ...
                    ref={refDN}
                    defaultValue={selectedEmployee.date_de_naissance}
                  ></input>
                </div>
                <div className="col-md-6">
              ...
              <div className="row mb-2">
                <div className="col-md-6">
                  <label htmlFor="date_de_recrutement">
                    Date de recrutement
                  </label>
                  <input
                    className="form-control"
                    ...
                    ref={refDRc}
                    defaultValue={selectedEmployee.date_de_recrutement}
                  ></input>
                </div>
                <div className="col-md-6">
                  ...
                  <select
                    ...
                    ref={refDR}
                    defaultValue={selectedEmployee.direction_id}
                  >
              ...
              <div className="row mb-2">
                ...
                <div className="col-md-6">
                  ...
                  <input
                    ...
                    name="user_id"
                    ref={refU}
                    defaultValue={selectedEmployee.user_id}
                  ></input>
                </div>
              </div>
              <div className="d-flex flex-row-reverse">
                ...
                <div className="p-2">
                  <Link to="/employes" className="btn btn-danger my-2 mr-2">
