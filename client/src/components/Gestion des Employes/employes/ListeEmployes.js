        ...
        <div className="row">
          {searchInput.length > 1
            ? filteredResults.map((item) => {
                return (
                  <div
                    className="row mb-1 mr-0 custom-border bg-light"
                    key={item._id}
                  >
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-10">
                          <div className="row ">
                            {tabDirections &&
                              tabDirections.map((d) => {
                                if (d._id === item.direction_id) return d.name;
                              })}
                          </div>
                        </div>
                      </div>
           ...
           >
             ...
             <FaEdit />
                        ...
                        <button
                          ...
                          onClick={function removeC() {
                            if (
                              window.confirm(
                                "Etes-vous sur de bien vouloir supprimer cet employé ? "
                              )
                            ) {
                      ...
                      <Box sx={style}>
                        <div>
                          ...
                          <div className="row">
                            ...
                            <div className="col-11">
                              Date de recrutement:{" "}
                              {moment(item.date_de_recrutement)
                                .locale("fr")
                                .calendar()}{" "}
                            </div>
                          </div>
