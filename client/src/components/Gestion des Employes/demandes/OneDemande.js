...
export default function OneDemande(props) {
  ...
  if (APIData && employee) {
    return (
      <div>
        <li className="list-group-item my-1 shadow p-3">
          <div className="row">
            ...
            >
              {props.demande.etat === "non_traitee" ? (
                <div className="text-success">
                  Marquer comme traitée <FaCheck className="mx-2 " />
                </div>
              ) : (
                <div className="text-danger">
                  Marquer comme non traitée <FcCancel></FcCancel>
                </div>
              )}
            </button>
            {/*        <button
        ...
        >
          <Box sx={style}>
            ...
            >
              ...
              <b>
                {" "}
                Envoyé par: {employee.prenom} {employee.nom}
              </b>{" "}
              <hr></hr>
            </Typography>
            <Typography id="keep-mounted-modal-description" sx={{ mt: 2 }}>
              <b> Date Demande:</b>{" "}
              {moment(props.demande.dateDemande).locale("fr").format("ll")}
              <br />
              <b> Details Demande:</b> {props.demande.detailsDemande}
              <br />
