...
export default function HolderDemande() {
  ...
  return (
    ...
    <h1 className='display-3'>Mes demandes</h1><hr/>
    </div>
    <div className=' card col ml-0 my-3 '>
            <NouvelleDemande tabUsers={tabUsers} tabStaff={tabStaff} ></NouvelleDemande>
        </div>
        <div className=" card col ml-0 my-3 ">
            <ListeDemandes tabUsers={tabUsers} tabStaff={tabStaff}></ListeDemandes>
        </div>
</div>
</div>
  )
